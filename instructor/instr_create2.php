...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    $query = "INSERT INTO assessments(instructor, name, public, duration, open_date, open_time, close_date, close_time, content, course_name, course_id, section_id)
              VALUES ('" . $_SESSION["email"] . "', '" . $name . "', '" . $public . "', " . $duration . ", '" . $open_date  . "', '" . $open_time . "', '" . $close_date  . "', '" . $close_time . "', '" . $json_content
              . "', '" . $_SESSION['selected_course_name'] . "', '" . $_SESSION['selected_course_id'] . "', '" . $_SESSION['selected_section_id'] . "')";
    $res = pg_query($con, $query);

    // check for errors
    if(!$res) {
        $result = "Assessment creation was not successful.";
    } else {
