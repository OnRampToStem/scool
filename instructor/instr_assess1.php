...
// globals
$students = array(); // php assoc arr holding "first name last name" => "email" of students belonging to instr
...
// course name, course id, and section id
$query = "SELECT * FROM users WHERE instructor = '{$_SESSION["email"]}' AND course_name = '{$_SESSION["selected_course_name"]}'
          AND course_id = '{$_SESSION["selected_course_id"]}' AND section_id = '{$_SESSION["selected_section_id"]}'";
...
foreach($students as $key => $value){
    ...
    $json_filename = "../user_data/{$_SESSION['selected_course_name']}-{$_SESSION['selected_course_id']}-{$_SESSION['selected_section_id']}/questions/" . $value . ".json";
