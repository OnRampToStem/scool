...
// first query - instructor's assessments that were created for the selected_course_name,
// selected_course_id, and the selected_section_id
...
// second query - public assessments not belonging to current logged in instructor
        ...
        <script type="text/javascript">
            ...
            let updateAssessmentResponse = () => {
                if(req3.readyState == 4 && req3.status == 200) {
                    ...
                    alert("Success updating assessment.");
            ...
            let deleteAssessmentResponse = () => {
                if(req2.readyState == 4 && req2.status == 200){
                    ...
                    alert("Success deleting assessment.");
                    window.location.reload();
                }
            }
