...
// initialize the session (access to user: loggedIn, first_name, email, type, course_name, course_id, section_id,
...
// filepath
$json_filename = "../../user_data/{$_SESSION['selected_course_name']}-{$_SESSION['selected_course_id']}-{$_SESSION['selected_section_id']}/questions/" . $user . ".json";
...
// filepath
$json_filename = "../../user_data/{$_SESSION['selected_course_name']}-{$_SESSION['selected_course_id']}-{$_SESSION['selected_section_id']}/openStax/" . $user . ".json";
// read the file to text
$json = file_get_contents($json_filename);
// decode the text into a PHP assoc array
