...
<body onload="initialize();">
    ...
    <script type="text/javascript">
        ...
        // JS GLOBALS //
        ////////////////
        let index = 0; // index of the currently displayed static question
        let selectedQuestions; // array containing all of the static questions for the selected learning outcome
        let totalQuestions; // total number of questions in selectedQuestions
        let correctAnswers = []; // array containing the correct answers for all the questions in selectedQuestions
        ...
        const storeCorrectAnswersAndShuffle = () => {
            for (let i = 0; i < selectedQuestions.length; i++) {
                ...
                let correctIndex = 0;
                for (let j = 0; j < selectedQuestions[i]["rightAnswer"].length; j++) {
                    if (selectedQuestions[i]["rightAnswer"][j] === true) {
                        break;
                    }
                    correctIndex++;
                }
