...
if ($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    $query = "INSERT INTO assessments_results (assessment_name, instructor_email, student_email, course_name, course_id, date_time_submitted, score, content)
              VALUES ('{$assessment_name}', '{$instructor_email}', '{$_SESSION['email']}', '{$_SESSION['course_name']}', '{$_SESSION['course_id']}', '{$date_time_submitted}', {$score}, '{$content}')";
