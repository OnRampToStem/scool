...
// if user account type is not 'student' then redirect then force logout
...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    // filepath
    $json_filename = "../user_data/" . $_SESSION['course_name'] . "-" . $_SESSION['course_id'] . "-" . $_SESSION['section_id'] . "/questions/" . $_SESSION["email"] . ".json";
    ...
    if(!$already_selected){
        ...
        // else $selected_questions contains data that we need to deal with
            ...
            $json_filename = "../user_data/" . $_SESSION['course_name'] . "-" . $_SESSION['course_id'] . "-" . $_SESSION['section_id'] . "/openStax/" . $_SESSION["email"] . ".json";
            $json = file_get_contents($json_filename);
            $json_data = json_decode($json, true);
            ...
            $myfile = fopen("/Applications/MAMP/htdocs/hub_v1/user_data/" . $_SESSION['course_name'] . "-" . $_SESSION['course_id'] . "-" . $_SESSION['section_id'] . "/questions/" . $_SESSION["email"] . ".json", "w") or die("Unable to open file!");
    ...
    <body onload="GetData()">
        ...
        <script type="text/javascript">
            ...
            let updateOpenStax = () =>{
                ...
                req_update.send("user=<?= $_SESSION["email"]; ?>&ch_num=" + ch_num + "&sec_num=" + sec_num + "&lo_num=" + lo_num);
            }
            ...
            let getChapterData = () =>{
                ...
                if(chapter_clicked){
                    ...
                    request_ch.send("user=<?= $_SESSION["email"]; ?>");
                }
            }
            ...
            let getSectionData = () =>{
                ...
                if(section_clicked){
                    ...
                    request_sec.send("user=<?= $_SESSION["email"]; ?>&chapter=" + chapter);
                }
            }
            ...
            let getLoData = () =>{
                ...
                if(lo_clicked){
                    ...
                    request_lo.send("user=<?= $_SESSION["email"]; ?>&chapter=" + chapter + "&section=" + section);
                }
            }
            ...
            let getChapterOptions = () => {
                ...
                ch_req.send("user=<?= $_SESSION["email"]; ?>");
            }
            ...
            let getSectionOptions = () => {
                ...
                sec_req.send("user=<?= $_SESSION["email"]; ?>&chapter=" + chapter);
            }
            ...
            let getLoOptions = () =>{
                ...
                lo_req.send("user=<?= $_SESSION["email"]; ?>&chapter=" + chapter + "&section=" + section);
            }
            ...
            let checkAccess = () => {
                ...
                req1.send("user=<?= $_SESSION["email"]; ?>&ch=" + ch + "&sec=" + sec + "&lo=" + lo);
            }
